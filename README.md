...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 64 agents, 261 skills, and 85 legacy command shims.
...
**That's it!** You now have access to 64 agents, 261 skills, and 85 legacy command shims.
